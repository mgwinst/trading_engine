...
public:
    ...
    // debug
    std::vector<std::pair<Price, Volume>> get_bids() const noexcept { return bid_levels_; }
    std::vector<std::pair<Price, Volume>> get_asks() const noexcept { return bid_levels_; }
