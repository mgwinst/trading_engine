...
clang++ -std=c++23 -g -I$TRADING_ENGINE_HOME -I$TRADING_ENGINE_HOME/core -I$TRADING_ENGINE_HOME/core/common -I$TRADING_ENGINE_HOME/deps main.cpp \
    ...
    $TRADING_ENGINE_HOME/core/network/socket/feed_handler.cpp $TRADING_ENGINE_HOME/core/parser/msg_handler.cpp \
    $TRADING_ENGINE_HOME/core/parser/msg_parser.cpp $TRADING_ENGINE_HOME/core/orderbook/orderbook_manager.cpp && sudo ./a.out
